...
//Minor modifications (colour etc) by Matthew Moldowan
var fireWorksHaveNotPlayed = true;

function startFireworks() {
  $('#fireworks').attr('href','styles/css-fireworks.css');

  if(fireWorksHaveNotPlayed)
  {
	  fireWorksHaveNotPlayed = false;
	  var num_launchers = 6;
	  var num_flares = 20;
	  var flare_colours = ['yellow', 'white'];
	  ...
	  for(var i=0; i < num_launchers; i++) {
		...
		document.getElementById("battleArena").appendChild(newdiv);
	  }
  }
};
